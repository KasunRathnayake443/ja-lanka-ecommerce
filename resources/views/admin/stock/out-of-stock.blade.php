...
@section('page_title', 'Out of Stock Products')

@section('content')
<div class="bg-white rounded-xl shadow-md overflow-hidden">
    <div class="px-6 py-4 border-b bg-gray-50 flex justify-between items-center">
        <div>
            <h2 class="text-xl font-semibold">🚫 Out of Stock Products</h2>
            <p class="text-sm text-gray-500">Products with zero inventory</p>
        </div>
    ...
    <div class="px-6 py-4 border-b bg-gray-50">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div>
                ...
                <a href="{{ route('admin.stock.out-of-stock') }}" class="text-gray-500 text-sm ml-2 hover:underline">Reset</a>
            </div>
        </form>
    </div>
