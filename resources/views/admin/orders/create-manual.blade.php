                ...
                <div id="guest-user-section" class="hidden mb-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="guest_name" class="w-full px-3 py-2 border rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                            <input type="email" name="guest_email" class="w-full px-3 py-2 border rounded-lg">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Mobile Number *</label>
                            <input type="text" name="guest_mobile" class="w-full px-3 py-2 border rounded-lg">
                        </div>
                    </div>
                </div>
        ...
        try {
            ...
            if (!products || products.length === 0) {
                ...
                searchResults.innerHTML = products.map(p => {
                    // Safely encode name for use inside onclick attribute
...
})(); // immediately invoked — DOM is already ready at @stack('scripts')
</script>
@endpush
@endsection