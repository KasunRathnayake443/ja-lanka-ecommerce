...
<div class="pb-24">
    ...
    <div id="emptyWishlist" class="text-center py-12 hidden px-4">
        ...
        <a href="{{ route('mobile.shop') }}" class="inline-block mt-4 text-red-600 hover:underline">Start Shopping</a>
    </div>
</div>
    ...
    if (!isLoggedIn) {
        document.getElementById('wishlistItems').innerHTML = `
            <div class="text-center py-12">
                ...
                <a href="{{ route('login') }}" class="inline-block bg-red-600 text-white px-6 py-2 rounded-lg">Login</a>
            </div>
        `;
        return;
    }
