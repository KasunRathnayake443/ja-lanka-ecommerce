...
@section('title', 'My Account - Ja Lanka')
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1">
            <div class="bg-white border border-gray-100 rounded-lg p-6">
                <h2 class="text-2xl font-light font-['Cormorant_Garamond'] mb-6">Welcome back, {{ Auth::user()->name }}</h2>
                    ...
                    <div class="bg-gray-50 rounded-lg p-5">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900">LKR {{ number_format($totalSpent, 2) }}</p>
                            </div>
                ...
                <div>
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('account.orders') }}" class="text-sm text-red-700 hover:underline">View All Orders →</a>
                    </div>
                    @endif
                </div>
                @else
