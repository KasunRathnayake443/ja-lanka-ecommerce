        ...
        <div class="flex items-center justify-between">
           ...
           <!-- Center Navigation -->
            <nav class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('shop') }}?type=food" class="text-gray-700 hover:text-red-600 transition {{ request()->get('type') == 'food' ? 'text-red-600 font-semibold' : '' }}">
                    Foods
                </a>
                <a href="{{ route('shop') }}?type=appliance" class="text-gray-700 hover:text-red-600 transition {{ request()->get('type') == 'appliance' ? 'text-red-600 font-semibold' : '' }}">
                    Appliances
                </a>
                <a href="{{ route('about') }}" class="text-gray-700 hover:text-red-600 transition {{ request()->routeIs('about') ? 'text-red-600 font-semibold' : '' }}">
                    About Us
                </a>
                <a href="{{ route('contact') }}" class="text-gray-700 hover:text-red-600 transition {{ request()->routeIs('contact') ? 'text-red-600 font-semibold' : '' }}">
                    Contact Us
                </a>
            </nav>
                ...
                @auth
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 hidden z-20">
                            <a href="{{ route('account.dashboard') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Dashboard</a>
                            <a href="{{ route('account.orders') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">My Orders</a>
                            <hr class="my-1">
