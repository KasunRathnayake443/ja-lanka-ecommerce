...
<body class="bg-gray-50">
    ...
    <!-- Desktop Header -->
    <?php echo $__env->make('layouts.partials.desktop-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    
    <!-- Main Content - Add top padding for all pages except homepage -->
    <main class="min-h-screen <?php echo e(request()->routeIs('home') ? '' : 'pt-20 md:pt-24'); ?>">
    ...
    <!-- Cart Modal -->
    <?php echo $__env->make('layouts.partials.cart-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <!-- Wishlist Modal -->
    <?php echo $__env->make('layouts.partials.wishlist-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            if (data.length === 0) {
                wishlistContent.innerHTML = `
                    <div class="text-center py-12">
                        ...
                        <a href="<?php echo e(route('shop')); ?>" class="inline-block mt-4 text-red-600 hover:underline">Start Shopping</a>
                    </div>
                `;
                return;
            }
...
</html><?php /**PATH C:\Users\Kasun Rathnayake\Herd\ja-lanka-ecommerce\resources\views/layouts/desktop.blade.php ENDPATH**/ ?>