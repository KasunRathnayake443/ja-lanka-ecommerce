...
<section class="section-wrap">
    ...
    <div class="categories-grid">
        <a href="<?php echo e(route('shop')); ?>?type=food" class="cat-card">
        ...
        <a href="<?php echo e(route('shop')); ?>?type=appliance" class="cat-card">
            <div class="cat-card-inner">
        ...
        <a href="<?php echo e(route('mobile.sale')); ?>" class="cat-card">
            <div class="cat-card-inner">
        ...
        <a href="<?php echo e(route('shop')); ?>?sort=newest" class="cat-card">
            <div class="cat-card-inner">
...
>
    <div class="section-head section-head--inline">
        ...
        <a href="<?php echo e(route('mobile.sale')); ?>" class="view-all-link">View all deals →</a>
    </div>
...
>
    <div class="section-head section-head--inline">
        ...
        <a href="<?php echo e(route('shop')); ?>" class="view-all-link">Browse all →</a>
    </div>
...
>
    <div class="section-head section-head--inline">
        ...
        <a href="<?php echo e(route('shop')); ?>?sort=newest" class="view-all-link">See all →</a>
    </div>
