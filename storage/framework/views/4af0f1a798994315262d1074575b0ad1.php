        ...
        <div class="flex-1">
            <div class="bg-white border border-gray-100 rounded-lg p-6">
                ...
                <?php if(session('success')): ?>
                    <div class="mb-4 p-3 bg-green-100 text-green-700 rounded-lg"><?php echo e(session('success')); ?></div>
                <?php endif; ?>
                
                <?php if(session('error')): ?>
                    <div class="mb-4 p-3 bg-red-100 text-red-700 rounded-lg"><?php echo e(session('error')); ?></div>
                <?php endif; ?>
                        ...
                        <div class="md:col-span-2 flex items-center gap-4 mb-4">
                            ...
                            <?php else: ?>
                                <div class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center">
                                    <span class="text-2xl font-bold text-red-700"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                                </div>
                            <?php endif; ?>
                            <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="tel" name="mobile" value="<?php echo e(old('mobile', Auth::user()->mobile)); ?>" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:border-red-500 focus:outline-none">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.desktop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\ja-lanka-ecommerce\resources\views/account/profile.blade.php ENDPATH**/ ?>