...
<div class="bg-white rounded-xl shadow-md p-8">
    ...
    <p class="text-gray-600">You are logged in as: <strong class="text-gray-900"><?php echo e(Auth::guard('admin')->user()->name); ?></strong></p>
    <p class="text-gray-600 mb-6">Email: <strong class="text-gray-900"><?php echo e(Auth::guard('admin')->user()->email); ?></strong></p>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Kasun Rathnayake\Herd\ja-lanka-ecommerce\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>