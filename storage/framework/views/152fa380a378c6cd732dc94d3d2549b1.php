<?php $__env->startSection('page_title', 'Add Product'); ?>
                ...
                <div id="originField" style="display: none;">
                    ...
                    <select name="origin_id" class="w-full px-3 py-2 border rounded-lg focus:border-red-500">
                        ...
                        <?php $__currentLoopData = $origins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $origin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($origin->id); ?>"><?php echo e($origin->flag_icon); ?> <?php echo e($origin->country_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ja-lanka-ecommerce\resources\views/admin/products/create.blade.php ENDPATH**/ ?>